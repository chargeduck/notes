...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">configure</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> arguments:</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --with-http_auth_request_module</span></span></code></pre></div><h1 id="_3-修改nginx配置文件" tabindex="-1">3. 修改nginx配置文件 <a class="header-anchor" href="#_3-修改nginx配置文件" aria-label="Permalink to &quot;3. 修改nginx配置文件&quot;">​</a></h1>`,6),d=a(`<div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">location</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ^~</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /images/data-collector/video-alarm/</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div>`,3);function c(g,F,_,y,u,E){const i=p("font");return t(),e("div",null,[o,s("p",null,[s("strong",null,[l(i,{color:"red"},{default:h(()=>[k("这段配置文件加在 api和 ^~ images 中间！")]),_:1})])]),d])}const B=n(r,[["render",c]]);export{m as __pageData,B as default};
